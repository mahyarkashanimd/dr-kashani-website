...
- [x] **P2b. Nav rollout for /penile-doppler** — Verified 2026-09-08: mega-dropdown already has `/penile-doppler` and `/penile-injections` under "Erectile Dysfunction" on every EN nav-bearing page (checked all 67 pages, none missing). Doc was stale — this was already shipped.
